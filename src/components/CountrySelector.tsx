  ...
  return (
    <div ref={ref} className="relative">
      <button
        ...
        aria-expanded={open}
        className="flex items-center gap-2 rounded-md border border-border bg-card px-3 py-1.5 font-mono text-xs uppercase tracking-wider text-foreground transition-colors hover:border-primary"
      >
        <img
      ...
      {open && (
        <ul
          role="listbox"
          className="absolute left-0 top-full z-50 mt-1 max-h-72 w-56 overflow-y-auto rounded-md border border-border bg-card py-1 shadow-lg"
        >
          {COUNTRIES.map((c) => {
