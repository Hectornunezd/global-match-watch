...
const COUNTRY_NAMES: Record<string, { en: string; es: string }> = {
  ...
  HKG: { en: "Hong Kong", es: "Hong Kong" },
  SGP: { en: "Singapore", es: "Singapur" },
  IDN: { en: "Indonesia", es: "Indonesia" },
  PHL: { en: "Philippines", es: "Filipinas" },
  TWN: { en: "Taiwan", es: "Taiwán" },
  MNG: { en: "Mongolia", es: "Mongolia" },
  KHM: { en: "Cambodia", es: "Camboya" },
  MAC: { en: "Macao", es: "Macao" },
  TLS: { en: "Timor-Leste", es: "Timor-Leste" },
  NPL: { en: "Nepal", es: "Nepal" },
  MDV: { en: "Maldives", es: "Maldivas" },
  MYS: { en: "Malaysia", es: "Malasia" },
  THA: { en: "Thailand", es: "Tailandia" },
  BRN: { en: "Brunei", es: "Brunéi" },
  LAO: { en: "Laos", es: "Laos" },
  ARE: { en: "United Arab Emirates", es: "Emiratos Árabes Unidos" },
  KWT: { en: "Kuwait", es: "Kuwait" },
  KAZ: { en: "Kazakhstan", es: "Kazajistán" },
  KGZ: { en: "Kyrgyzstan", es: "Kirguistán" },
  TJK: { en: "Tajikistan", es: "Tayikistán" },
  TKM: { en: "Turkmenistan", es: "Turkmenistán" },
};
